...
const SOCIAL_LINKS = [
  ...
  { icon: Instagram, link: "https://www.instagram.com/jeaann.c/" }
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%] pt-16" id="Home">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Passionate about building intelligent, high-performance digital solutions. I specialize in modern web development and AI integration — from crafting responsive frontends to designing robust backend architectures.
                </p>
