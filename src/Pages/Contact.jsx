...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Change to your email in FormSubmit
      const formSubmitUrl = 'https://formsubmit.co/jean041519@gmail.com';
      ...
      submitData.append('_subject', 'New Message from Website Portfolio');
